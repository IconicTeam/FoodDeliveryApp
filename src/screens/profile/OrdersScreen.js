                            ...
                            <View style={{
                                ...
                                <View>
                                    <Text style={{
                                        ...
                                        fontSize: SIZES.mediumFontSize,
                                        color: defaultTheme.text2
                                    }}>{item.order_items[0].item_name}x{item.order_items[0].item_count}</Text>
                                </View>
                                <View>
                                    <Text style={{
                                        fontFamily: "Tajawal",
                                        fontSize: SIZES.mediumFontSize,
                                        color: defaultTheme.text2
                                    }}>{item.order_items[0].item_price * item.order_items[0].item_count}</Text>
                                </View>
                            </View>
                            <View style={{
                                flexDirection: "row",
                                ...
                                <View>
                                    <Text style={{
                                        ...
                                        fontSize: SIZES.smallFontSize,
                                        // color: defaultTheme.
                                    }}>و {item.order_items.length} طلبات اخرى</Text>
                                </View>
                                <View style={{
                                    alignItems: "center"
                                }}>
